...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_type', models.CharField(choices=[('classic', 'Publication Classique'), ('collab', 'Demande de Collaboration'), ('offer', "Offre d'emploi")], default='classic', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collaborators', models.ManyToManyField(blank=True, related_name='project_collaborators', to=settings.AUTH_USER_MODEL)),
